...
ImGuiStyle::ImGuiStyle()
{
    ...
    SliderHThickness = 100.0f;           // % of maximal tab rectangle thickness. Set to 100.0f to have rectangular slider, 0.0f to eliminate it.
    SliderVThickness = 100.0f;           // % of maximal tab rectangle thickness. Set to 100.0f to have rectangular slider, 0.0f to eliminate it.
...
static const ImGuiStyleVarInfo GStyleVarInfo[] =
{
    ...
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(ImGuiStyle, SliderHThickness) },   // ImGuiStyleVar_SliderHThickness
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(ImGuiStyle, SliderVThickness) },   // ImGuiStyleVar_SliderVThickness
