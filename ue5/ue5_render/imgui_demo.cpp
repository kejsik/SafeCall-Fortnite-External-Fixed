...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Vertical Sliders"))
    {
        ...
        ImGui::SliderFloat("SliderVThickness", &style.SliderVThickness, 5.0f, 100.0f, "%.0f"); // Minimal displayed value is 5%
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    ImGui::SliderFloat("SliderHThickness", &style.SliderHThickness, 5.0f, 100.0f, "%.0f"); // Minimal displayed value is 5%
    ImGui::SliderFloat("SliderVThickness", &style.SliderVThickness, 5.0f, 100.0f, "%.0f"); // Minimal displayed value is 5%
